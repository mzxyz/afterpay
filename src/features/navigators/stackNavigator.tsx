...
export const ShopNavigator = () => (
	<Stack.Navigator>
		<Stack.Screen name="Shop" component={ShopPage} options={{ header: () => null }} />
	</Stack.Navigator>
);

export const OrdersNavigator = () => (
	<Stack.Navigator>
		<Stack.Screen name="Orders" component={ShopPage} />
	</Stack.Navigator>
);

export const InStoreNavigator = () => (
	<Stack.Navigator>
		<Stack.Screen name="MY IN-STORE CODE" component={InStorePage} />
	</Stack.Navigator>
);

export const ProfileNavigator = () => (
	<Stack.Navigator>
		<Stack.Screen name="Profile" component={ShopPage} />
	</Stack.Navigator>
);
